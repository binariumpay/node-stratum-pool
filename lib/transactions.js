...
exports.CreateGeneration = function(rpcData, publicKey, extraNoncePlaceholder, reward, txMessages, recipients, coinbaseText){
    ...
    var txComment = txMessages === true ?
        util.serializeString('https://github.com/binariumpay/node-stratum-pool') :
        new Buffer([]);
    ...
    var scriptSigPart2 = util.serializeString(coinbaseText ? coinbaseText : '/nodeStratum/');
