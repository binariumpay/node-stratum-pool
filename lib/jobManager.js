...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        console.log ( "jobManager.js : processShare () : jobId : " + jobId +
        ...
        console.log ( "jobManager.js : processShare () : headerBigNum : " + headerBigNum + " , job.target.ge(headerBigNum) : " + job.target.ge(headerBigNum) + " ." );
        console.dir ( headerBuffer );
